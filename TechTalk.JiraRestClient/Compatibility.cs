...
namespace TechTalk.JiraRestClient
{
    ...
    public class JiraClient : IJiraClient
    {
        ...
        {
            return client.GetIssuesQuery(filter).ToArray();
        }
        ...
        {
            return client.GetIssueChangelog(issueKey);
        }

        public EditMeta GetEditMeta(String issueKey)
        {
            return client.GetEditMeta(issueKey);
        }
        ...
        public void AddWatcher(String issueKey, String username)
        {
            client.AddWatcher(issueKey, username);
        }
    }
